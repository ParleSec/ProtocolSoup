...
export const STANDARD_ACTORS: Record<string, LookingGlassActor> = {
  ...
  verifier: {
    ...
    name: 'Verifier',
    type: 'resource',
    description: 'Requests and validates verifiable presentations',
    icon: 'shield-check',
  },
  wallet: {
    id: 'wallet',
    name: 'Wallet',
    type: 'client',
    description: 'Holds credentials and responds to verifier requests',
    icon: 'wallet',
  },
  holder_device: {
    id: 'holder_device',
    name: 'Holder Device',
    type: 'user',
    description: 'End-user device controlling wallet interactions',
    icon: 'smartphone',
  },
  scim_server: {
    id: 'scim_server',
