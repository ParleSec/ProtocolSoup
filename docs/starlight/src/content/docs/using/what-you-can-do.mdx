...
| **Wallet Harness** | Hosted OID4VCI/OID4VP wallet at [wallet.protocolsoup.com](https://wallet.protocolsoup.com) for issuance, presentation, QR handoff, and HAIP attestation |
