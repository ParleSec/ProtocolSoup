...
| SSF | [CAEP Session Revoked](https://protocolsoup.com/looking-glass?protocol=ssf&flow=caep-session-revoked) | Real-time security event stream with receiver response |
