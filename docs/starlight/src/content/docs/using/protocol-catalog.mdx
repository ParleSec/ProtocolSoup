...
**Standards:** RFC 6749, RFC 7636 (PKCE), RFC 8628 (Device Authorization), RFC 7662 (Introspection), RFC 7009 (Revocation), RFC 9700 (Security BCP)
...
| Implicit Grant (Legacy) | RFC 6749 §4.2 fragment access token; RFC 9700 §2.1.2 says clients SHOULD NOT use it |
| Device Authorization | RFC 8628 grant for input-constrained devices; person authorizes on a second device |
