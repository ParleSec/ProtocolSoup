...
- Client ID schemes supported: `redirect_uri`, `did:web`, `verifier_attestation`, and `x509_san_dns` when the corresponding verifier identity material is configured.
