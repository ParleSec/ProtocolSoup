...
Verifier presents a signed attestation JWT. The verifier's attestation issuer publishes OpenID discovery metadata and JWKS. The wallet validates the attestation JWT against the published JWKS.
