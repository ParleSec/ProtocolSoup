...
4. Wallet drives the standard OAuth 2.0 authorization code flow against
   `authorization_endpoint`, then exchanges the code at
...
These controls are exercised by backend regression tests.
