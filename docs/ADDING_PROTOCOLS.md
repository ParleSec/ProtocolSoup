...
>
> Starlight source for that page: `docs/starlight/src/content/docs/developers/extending/add-a-protocol.mdx`
>
> Keep this file and the MDX page in sync when steps or paths change. This legacy Markdown copy remains for in-repo search and deep links.
